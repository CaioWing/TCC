...
\titulo{Otimiza\c{c}\~ao de Baixo N\'ivel em Vision Transformers: Desenvolvimento de Kernels de Infer\^encia Customizados para Efici\^encia de SRAM}
\titleabstract{Hardware-Aware Optimization of Vision Transformers: Implementing High-Performance Inference Kernels for SRAM Efficiency}
\tituloresumo{Otimiza\c{c}\~ao de Baixo N\'ivel em Vision Transformers: Desenvolvimento de Kernels de Infer\^encia Customizados para Efici\^encia de SRAM}
\autor{Caio Wingeter de Castilho}
\autorficha{Castilho, Caio Wingeter de}
\autorabr{CASTILHO, C. W.}
...
\orientadorcorpoficha{orientador Glauco Caurin}
\orientadorficha{Caurin, Glauco, orient}
...
\ifthenelse{\equal{#1}{EPRO}}{
	...
	\notaficha{Monografia (Gradua\c{c}\~ao em Engenharia de Produ\c{c}\~ao)}
}{		         	
% Outros
	\tipotrabalho{Monografia (Trabalho de Conclus\~ao de Curso)}
	\tipotrabalhoabs{Monograph (Conclusion Course Paper)}
